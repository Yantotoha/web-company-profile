...
class ServicesController extends Controller
{
    ...
    {
        return view('pages.editor.services.index');
    }
...
public function getData(Request $request): JsonResponse
{
    ...
    $limit = $request->input('length', 10); // gunakan `length` agar sesuai DataTable
    ...
    try {
        ...
        $service_total = $query->count(); // total data sebelum limit-offset
        ...
        $data = [
            ...
            'recordsTotal' => $service_total,
            'recordsFiltered' => $service_total,
            'data' => $services,
        ];
    } catch (QueryException $e) {
        Log::error('QueryException: ' . $e);
        $data = ['error' => 'Terjadi kesalahan saat mengambil data'];
    } catch (Exception $e) {
