        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="Tport" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>Title</th>
                                <th>Slug</th>
                    ...
                    <div class="modal-body">
                        <div class="form-grop row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Description</label>
                                    <input type="text" id="des_update" name="des" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
    ...
    <script>
        ...
        $('document').ready(function(e) {
            var Tport = $('#Tport').DataTable({
                ...
                "paging": true,
                "ajax": {
                    "url": "{{ route('admin.portfolio.data') }}",
                    "data": function(parm) {
            ...
            $("#proses_add").click(function() {
                ...
                $.ajax({
                    url: "{{ URL::route('admin.portfolio.store') }}",
                    data: postData,
                    type: "POST",
                    dataType: "JSON",
                    cache: false,
            ...
            // tombol update data
            $("#Tport tbody").on('click', '.btnUpdate', function() {
                let data = Tport.row($(this).parents('tr')).data();
                let idData = data.id;
                $.ajax({
                    url: "{{ URL::route('admin.portfolio.detail') }}",
                    type: "GET",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        'id': idData
            ...
            $("#proses_update").click(function() {
                ...
                $.ajax({
                    url: "{{ URL::route('admin.portfolio.update') }}",
                    data: postData,
                    type: "POST",
                    dataType: "JSON",
                    cache: false,
            ...
            $("#Tport tbody").on('click', '.btnDelete', function() {
                let data = Tport.row($(this).parents('tr')).data();
                let idData = data.id;
                Swal.fire({
                    title: "Are you sure?",
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ URL::route('admin.portfolio.delete') }}",
                            type: "DELETE",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                'id': idData
